...
namespace TreeAlgorithms.TraversalEngine.UI
{
    public static class Program
    {
        private static void Main()
        {
            var tree = new BinarySearchTree.Implementations.BinarySearchTree(50);
            tree.BstInsert(72);
            tree.BstInsert(54);
            tree.BstInsert(76);
            tree.BstInsert(67);
            ...
            var traversalEngine = new Implementations.TraversalEngine();
